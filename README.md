...
| `terasort` | Sort events from an input Pravega `Stream` and then write sorted events to output streams. | [Java](hadoop-connector-examples/src/main/java/io/pravega/example/hadoop/terasort)
