...
public class AccessLog {
    ...
    public AccessLog() {
        clientIp=status=verb=timestamp="";
    }
    ...
    {
        Instant parsedTimestamp = Instant.parse(getTimestamp());
        java.util.Date date = java.util.Date.from( parsedTimestamp );
        return date.getTime();
    }
    ...
    public String toString() {
        return "AccessLog [timestamp = "+timestamp+", timestampMillis = "+getTimestampMillis()+", verb = "+verb+", status = "+status+", clientIp = "+clientIp+"]";
    }
}
